...
from services.autores_services import cadastrar_autor
from services.categorias_services import cadastrar_categoria
from services.editoras_services import cadastrar_editora
